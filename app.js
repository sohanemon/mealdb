  ...
  div.innerHTML = `
        ...
        <div class="p-5">
          ...
          <p class=" text-lg mb-5 text-gray-700 font-semibold my-2">
            ...
            <label for=${
              meal.idMeal
            } class="see-more w-full text-center cursor-pointer block rounded-md bg-blue-600 py-2 font-semibold text-blue-50 hover:text-white hover:bg-blue-500 hover:shadow-md duration-75">See More</label>
